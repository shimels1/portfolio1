          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-muted-foreground">
                I'm a <span className="text-indigo-400 font-medium">Full Stack Developer and Machine Learning Engineer</span> with 
            ...
            <a
              href="#contact"
              className="inline-block bg-indigo-500 hover:bg-indigo-600 text-white font-medium py-3 px-8 rounded-md transition-colors duration-300"
            >
              Contact Me
            </a>
          </div>
          ...
          <div className="bg-navy-700 p-8 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-navy-800 p-6 rounded-lg card-hover">
                <h4 className="text-xl font-bold mb-3 text-indigo-400">Certificate of Appreciation</h4>
                <p className="text-muted-foreground">
              ...
              <div className="bg-navy-800 p-6 rounded-lg card-hover">
                <h4 className="text-xl font-bold mb-3 text-indigo-400">Letter of Appreciation</h4>
                <p className="text-muted-foreground">
